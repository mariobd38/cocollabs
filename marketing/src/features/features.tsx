...
export function Features() {
    return (
        <div className='container sm:px-5 lg:px-0 pb-10 md:pt-24'>
            <div className='flex flex-col px-2.5 gap-6 font-["Geist"] text-center transition-all duration-500 ease'>
