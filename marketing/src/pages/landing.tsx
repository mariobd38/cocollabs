...
import LandingFooter from '@/features/footer';
import { Separator } from '@/components/ui/separator';
// import AuroraTextComp from '@/components/magicui/aurora-text';
...
function Hero() {
    ...
    const joinWaitlist = async () => {
        //const res = await join(form.getValues('email'));
        //console.log(res);
    }
                        ...
                        <div className='flex flex-col gap-10 font-["Geist"]'>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-4 xl:grid-cols-5 gap-16 items-center justify-center max-w-4xl lg:max-w-full m-auto lg:m-0">
                                ...
                                <div className="flex flex-col gap-4 lg:gap-8 lg:col-span-2 xl:col-span-2 ">
                                    ...
                                    <h1 className="font-bold text-gray-900/90 text-5xl sm:text-7xl tracking-tight leading-tight w-full z-5">
                                    Speed Up Code Reviews with <AuroraText> AI </AuroraText>
                                    </h1>
                                ...
                                <form onSubmit={form.handleSubmit(joinWaitlist)} className='flex w-full gap-4'>
                                    ...
                                    />
                                    <Button type="submit" className='hover:bg-primary/75 z-5 h-10'>Join the waitlist</Button>
                                </form>
                                </FormProvider>
{/* <Input
              startIcon={<Mail className="text-zinc-400" size={16} />}
              placeholder="johndoe@gmail.com"
              type="email"
              className="rounded-lg border border-gray-400 placeholder:text-muted-foreground bg-white text-zinc-800"
            />
            <Button type="submit" className='hover:bg-primary/75'>Join the waitlist</Button> */}
                                    </div>
                                </div>
