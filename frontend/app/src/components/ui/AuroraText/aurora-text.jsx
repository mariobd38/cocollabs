...
//       {...props}
//     >
//       <span className="relative z-10 mix-blend-lighten dark:mix-blend-darken">
//         {children}
//       </span>
...
export function AuroraText({
  ...
  return (
    <MotionComponent
      className={cn(
        "relative inline-block bg-gradient-to-r from-[hsl(var(--color-1))] via-[hsl(var(--color-2))] to-[hsl(var(--color-3))] bg-clip-text text-transparent animate-gradient",
        className
      )}
      {...props}
    >
