            ...
            {isOpen && (
                    <NavigationMenuContent style={{background: "#121217"}}  >
                        <ul className="list-none grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                            ...
                            <ListItem href="/docs/installation" title="Installation" className='fafafa-color nav-list-item'>
                                How to install dependencies and structure your app.
                            </ListItem>
                            <ListItem href="/docs/primitives/typography" title="Typography" className='fafafa-color nav-list-item'>
                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent style={{background: "#121217"}}>
                        <ul className="list-none grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                        {components.map((component) => (
                            <ListItem
                            key={component.title}
                            title={component.title}
                            href={component.href}
                            className='fafafa-color nav-list-item'
                            >
    ...
    <li>
      <NavigationMenuLink asChild>
        ...
        >
          ...
          <Title order={6} c='#fafafa' ff='Helvetica' className="leading-none">{title}</Title>
            {/* <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                {children}
            </p> */}
            <Text fz={13} c='#a9a9a9' ff='Helvetica'>
                {children}
            </Text>
        </a>
      </NavigationMenuLink>
