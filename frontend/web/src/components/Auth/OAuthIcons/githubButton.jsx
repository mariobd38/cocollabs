...
function GithubIcon(props) {
  return (
        <svg 
            ...
            y="0px"
            viewBox="0 0 97.6 96" 
            style={{ enableBackground: "new 0 0 97.6 96" }}
            xmlSpace="preserve"
        >
            <path fill="#FFFFFF" className="st0" d="M48.9,0C21.8,0,0,22,0,49.2C0,71,14,89.4,33.4,95.9c2.4,0.5,3.3-1.1,3.3-2.4c0-1.1-0.1-5.1-0.1-9.1
