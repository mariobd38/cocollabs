    ...
    return (
        <>
            ...
            <Flex bg='linear-gradient(0.25turn,#101216, #0e1523)' py={60} align='center' justify='center' w='100%' direction='column' gap={40} >
                ...
                <Title className='transition-all linear delay-100' c='#f0f0f0' maw='75%' fz={{base: 20, sm: 21.5}} fw={400} ff='Nunito Sans' textWrap='balance' ta='center' >404 error: This page could not be found</Title>
