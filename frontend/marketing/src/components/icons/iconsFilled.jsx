...
const iconList = [
        ...
        badges: ["app", "mobile", "display", "preview"]
    },  
        {       key: 'IconMugFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["tea", "coffee", "drink", "container", "jug"]
    },  
        ...
        badges: ["geometry", "adobe", "tool", "shape"]
    },  
        {       key: 'IconPointFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["shape", "delete", "remove", "close", "cancel"]
    },  
        ...
        badges: ["music", "song", "playlist", "melody", "device", "voice", "silence", "break"]
    },  
        ...
        badges: ["shape", "marbles", "balls", "juggle", "spots"]
    },  
        ...
        badges: ["bill", "restaurant", "shop", "price", "pay", "money", "total", "tax"]
    },  
        ...
        badges: ["shape", "toilet", "restroom", "male", "female"]
    },  
        ...
        badges: ["support", "question", "shape", "faq", "info"]
    },  
        {       key: 'IconPooFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["spirit", "transparent", "fairytale", "horror", "movie", "shadow", "haunt"]
    },  
        ...
        badges: ["medicine", "pharmaceutical", "pill", "treatment", "drug", "remedy", "softgel", "tablet", "health", "medication"]
    },  
        {       key: 'IconBulbFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["energy", "power", "electricity", "creativity", "light", "idea"]
    },  
        ...
        badges: ["information", "advice", "news", "tip", "sign"]
    },  
        ...
        badges: ["warning", "caution", "hex", "notify", "alert", "danger", "precaution", "risk", "crime", "signal"]
    },  
        ...
        badges: ["furniture", "sleeping", "comfortable", "bedroom", "mattress", "resting", "relax", "sleep", "futon", "cozy"]
    },  
        ...
        badges: ["drive", "vehicle", "direction", "turn", "holding", "racing"]
    },  
        ...
        badges: ["communication", "internet", "signal"]
    },  
        ...
        badges: ["html", "element", "layout", "divide", "position", "website"]
    },  
        ...
        badges: ["secure", "security", "closed", "key", "safety"]
    },  
        {       key: 'IconOvalFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["shape", "graphic", "egg", "circle", "zero"]
    },  
        ...
        badges: ["oven", "kitchen", "cooking", "food", "cook"]
    },  
        ...
        badges: ["vr", "virtual", "reality", "watch", "viewer", "technology"]
    },  
        ...
        badges: ["position", "element", "design"]
    },  
        ...
        badges: ["verify", "magnifying", "glass", "magnifier", "ok", "done"]
    },  
        ...
        badges: ["money", "earn", "salary", "change"]
    },  
        ...
        badges: ["park", "decoration", "water", "spring", "public"]
    },  
        ...
        badges: ["game", "figure", "strategy", "pawn"]
    },  
        ...
        badges: ["water", "drink", "beer", "energy", "wine"]
    },  
        ...
        badges: ["position", "element", "design", "around"]
    },  
        ...
        badges: ["warning", "attention", "caution", "inform", "notify", "square", "alarm", "signal", "warn", "alert"]
    },  
        {       key: 'IconBeerFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["alcohol", "drink", "beverage", "bar", "pub"]
    },  
        ...
        badges: ["cursor", "mouse", "point", "click", "arrow"]
    },  
        ...
        badges: ["equalizer", "sliders", "controls", "settings", "filter"]
    },  
        ...
        badges: ["alarm", "sound", "notification"]
    },  
        ...
        badges: ["inspect", "marketing", "search", "markup", "coding", "magnifier"]
    },  
        ...
        badges: ["animal", "insect", "nature", "fly", "wings"]
    },  
        ...
        badges: ["position", "design", "element", "doable"]
    },  
        ...
        badges: ["rain", "weather", "storm", "wet", "autumn", "fall"]
    },  
        ...
        badges: ["shape", "technology", "virtual", "reality", "device"]
    },  
        ...
        badges: ["shape", "brand", "copyright", "logo", "product"]
    },  
        ...
        badges: ["marijuana", "weed", "drug", "cbd", "medical"]
    },  
        ...
        badges: ["increase", "add", "amplify", "expand", "enhance", "augment", "boost", "replicate", "multiply", "grow"]
    },  
        ...
        badges: ["grid", "aside", "column", "columns"]
    },  
        ...
        badges: ["layout", "table", "network", "pattern"]
    },  
        ...
        badges: ["marketing", "promotion", "advertisement", "shape"]
    },  
        ...
        badges: ["bin", "litter", "recycle", "remove", "delete", "throw", "away", "waste"]
    },  
        ...
        badges: ["selected", "square", "magnifier", "diminishing"]
    },  
        {       key: 'IconMilkFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["food", "drink", "cow", "healthy", "breakfast", "bottle", "coffee"]
    },  
        ...
        badges: ["reduction", "price", "cost", "money", "shopping", "bargain", "tick", "done", "verified", "certificate", "valid", "official", "success"]
    },  
        {       key: 'IconHomeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["house", "dashboard", "living", "building"]
    },  
        ...
        badges: ["size", "photo", "elements", "adjust", "image"]
    },  
        ...
        badges: ["statistics", "diagram", "graph", "rhythm", "data", "analysis"]
    },  
        ...
        badges: ["flag", "ship", "sports", "championship", "mark", "spot", "winner"]
    },  
        ...
        badges: ["math", "linear", "statyscics", "graph"]
    },  
        ...
        badges: ["process", "plan", "planning", "diagram", "chart", "roadmap"]
    },  
        ...
        badges: ["shape", "geometric", "math", "2d"]
    },  
        ...
        badges: ["board", "attach", "nail", "pointed", "corkboard", "favourite", "noticeboard"]
    },  
        ...
        badges: ["shape", "geometric", "geometry", "figure"]
    },  
        {       key: 'IconShirtFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["plant", "desert", "spikes", "nature", "garden"]
    },  
        ...
        badges: ["light", "birthday", "decoration", "halloween", "fire", "christmas"]
    },  
        {       key: 'IconConeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["geometry", "math", "object", "shape"]
    },  
        ...
        badges: ["press", "steam", "fabric", "smooth", "crease", "heat", "iron", "garment", "wrinkle", "flatten"]
    },  
        ...
        badges: ["sale", "reduction", "price", "cost", "money", "shopping", "bargain"]
    },  
        ...
        badges: ["biscuit", "treat", "dessert", "snack", "sweet", "bake", "confection", "dough", "pastry", "crumb"]
    },  
        {       key: 'IconTagFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["generate", "power", "blade", "energy", "electricity"]
    },  
        ...
        badges: ["bag", "baggage", "folder", "carrier", "documents", "suitcase", "job", "work", "luggage"]
    },  
        ...
        badges: ["mattress", "sofa", "couch", "futon", "sleeping", "restful", "horizontal", "recline", "lying", "horizontal-bed"]
    },  
        ...
        badges: ["slideshow", "display", "exhibition", "speech", "topic", "conference"]
    },  
        {       key: 'IconBellXFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["alarm", "ring", "sound", "alert", "disabled"]
    },  
        {       key: 'IconBellZFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["alarm", "bell", "clock", "date", "snooze", "time"]
    },  
        {       key: 'IconLabelFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["tag", "sticker", "marker", "badge", "identifier", "notate", "record", "name", "plot"]
    },  
        ...
        badges: ["filter", "shift", "photography", "photo"]
    },  
        ...
        badges: ["automatic", "robot", "assistant", "support"]
    },  
        ...
        badges: ["animation", "shape", "design", "align"]
    },  
        {       key: 'IconPaintFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["brush", "renovation", "refurbishment", "color", "wall"]
    },  
        ...
        badges: ["judaism", "israel", "religion", "bright"]
    },  
        {       key: 'IconBikeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["cycling", "bicycle", "sport", "wheel"]
    },  
        ...
        badges: ["change", "convert", "adaptation", "direction"]
    },  
        {       key: 'IconFileFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["jigsaw", "extension", "add-on"]
    },  
        ...
        badges: ["shape", "accessiblity", "subtitles", "youtube", "netflix"]
    },  
        ...
        badges: ["animal", "dog", "cat", "foot", "pets"]
    },  
        {       key: 'IconChessFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["game", "strategy", "pawn", "figure"]
    },  
        {       key: 'IconSeedlingFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["nature", "greenery", "grow", "soil", "harvest", "plant", "flower", "tree", "leaf"]
    },  
        ...
        badges: ["help", "support", "shape", "information", "question"]
    },  
        {       key: 'IconLegoFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["construction", "stop", "traffic", "barricade", "street"]
    },  
        ...
        badges: ["warning", "notify", "warn", "caution", "danger", "message", "inform", "alarm", "signal", "square"]
    },  
        {       key: 'IconRadarFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["location", "navigation", "gps", "find", "signal", "technology", "submarine"]
    },  
        ...
        badges: ["order", "sequence", "decrease", "arrange", "reverse", "downward", "hierarchy", "logic", "pattern", "system"]
    },  
        {       key: 'IconSpadeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["cards", "casino", "poker", "shapes", "gamble"]
    },  
        ...
        badges: ["comment", "chat", "reply", "communication", "conversation", "faq", "message", "text"]
    },  
        ...
        badges: ["button", "player", "video", "film", "music", "cancel", "rewind", "reverse"]
    },  
        ...
        badges: ["button", "player", "video", "film", "music", "omit"]
    },  
        {       key: 'IconXboxXFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["controller", "joystick", "button"]
    },  
        ...
        badges: ["water", "clean", "hygiene", "bathroom", "tub"]
    },  
        {       key: 'IconBoomFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["blast", "explosion", "bang", "detonation", "burst", "erupt", "shockwave", "blowup", "kaboom", "boom"]
    },  
        ...
        badges: ["notification", "alarm", "alert", "remove", "ring"]
    },  
        ...
        badges: ["holidays", "pine", "decorate", "decoration", "gift", "present", "carol", "evergreen", "spruce", "fir", "winter"]
    },  
        {       key: 'IconLockFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["security", "password", "secure"]
    },  
        ...
        badges: ["media", "multimedia", "music", "audio", "control", "figures"]
    },  
        ...
        badges: ["subtract", "reduce", "deduct", "decrease", "lessen", "remove", "trim", "retract", "withdraw", "diminish"]
    },  
        ...
        badges: ["analytics", "data", "statistics", "graph"]
    },  
        ...
        badges: ["priority", "urgent", "highlight", "notable", "key", "marker", "tag", "significant", "flag", "pivotal"]
    },  
        {       key: 'IconClubsFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["card", "game", "casino", "gambling", "poker"]
    },  
        ...
        badges: ["vehicle", "ventilation", "cooling", "airflow", "automobile", "automotive", "auto", "drive", "climate", "mechanic"]
    },  
        {       key: 'IconKeyFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["password", "login", "authentication", "secure"]
    },  
        ...
        badges: ["landscape-crop", "aspect-ratio-landscape", "wide-crop", "landscape-mode", "horizontal-crop", "landscape-format", "wide-aspect", "horizontal-frame", "landscape"]
    },  
        {       key: 'IconXboxYFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["luck", "leaf", "patrick", "irleand", "irish"]
    },  
        ...
        badges: ["camping", "bonfire", "wood", "camp", "burn", "flame"]
    },  
        {       key: 'IconZoomFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["find", "magnifier", "magnifying", "glass"]
    },  
        ...
        badges: ["cog", "edit", "gear", "preferences", "tools"]
    },  
        {       key: 'IconBreadFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["food", "breakfast", "sandwich", "toast", "baking"]
    },  
        ...
        badges: ["transmission", "gear", "vehicle", "automation", "system", "car", "drive", "mechanism", "engage", "control"]
    },  
        ...
        badges: ["grid", "aside", "column", "columns", "menu", "navigation"]
    },  
        ...
        badges: ["breaking", "broken", "food", "breakfast"]
    },  
        ...
        badges: ["size", "dimension", "width", "height", "orientation"]
    },  
        ...
        badges: ["box", "index", "records", "old", "collect"]
    },  
        ...
        badges: ["alarm", "bell", "notification", "delete", "remove"]
    },  
        ...
        badges: ["magnetic", "field", "pole", "iron", "attract"]
    },  
        {       key: 'IconMailFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["inbox", "gmail", "email", "envelope", "message"]
    },  
        ...
        badges: ["safety", "protect", "protection"]
    },  
        ...
        badges: ["currency", "money", "bangladesh", "finance", "coin", "trade", "economy", "exchange", "wealth", "funds"]
    },  
        {       key: 'IconPinFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["thing", "localization", "maps", "clip", "place", "location"]
    },  
        ...
        badges: ["application", "add-on", "user", "download", "mobile"]
    },  
        ...
        badges: ["alarm", "notification", "alert", "set"]
    },  
        ...
        badges: ["corner", "shape", "element", "point"]
    },  
        {       key: 'IconBoltFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["energy", "power", "electricity", "storm", "lightning", "flash"]
    },  
        ...
        badges: ["enlargement", "shifting", "magnifier"]
    },  
        {       key: 'IconAdFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["advert", "advertisement", "marketing", "commercial", "traffic"]
    },  
        {       key: 'IconBookFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["read", "dictionary", "magazine", "library", "booklet", "novel"]
    },  
        ...
        badges: ["support", "aid", "assist", "guide", "rounded", "curved", "soften", "bubble", "smooth", "contour"]
    },  
        ...
        badges: ["shape", "close", "delete", "cross"]
    },  
        ...
        badges: ["shape", "video", "display", "resolution", "movie"]
    },  
        ...
        badges: ["sign", "hospital", "help", "indication"]
    },  
        {       key: 'IconFlagFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["banner", "pin", "report", "map", "warning", "alert"]
    },  
        {       key: 'IconGpsFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["navigation", "directions", "global", "positioning", "system", "satnav", "radionavigation", "travel", "car"]
    },  
        ...
        badges: ["hospital", "rate", "healthcare", "health"]
    },  
        ...
        badges: ["energy", "power", "electricity"]
    },  
        ...
        badges: ["explosion", "weapon", "military", "war"]
    },  
        ...
        badges: ["favorite", "like", "mark", "bookmark", "grade"]
    },  
        {       key: 'IconBowlFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["food", "soup", "kitchen", "vessel"]
    },  
        ...
        badges: ["support", "aid", "assist", "guide", "rectangle", "box", "frame", "border", "straight", "outline"]
    },  
        ...
        badges: ["grid", "view", "display", "page", "masonry"]
    },  
        ...
        badges: ["danger", "radioactive", "toxic", "microbe", "virus", "biotoxin"]
    },  
        ...
        badges: ["success", "win", "prize", "winner"]
    },  
        ...
        badges: ["medical-center", "healthcare", "clinic", "emergency", "hospital-round", "health", "care", "medical-facility", "circle-hospital", "health-center"]
    },  
        {       key: 'IconBowFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["arrow", "archer", "hunt", "hunter"]
    },  
        ...
        badges: ["mystery", "undefined", "unclear", "unidentified", "uncertain", "ambiguous", "obscure", "unseen", "anonymous", "unspecified"]
    },  
        ...
        badges: ["liquid", "container", "glass", "chemistry", "test", "laboratory", "experimental", "beta"]
    },  
        ...
        badges: ["music", "headset", "audio", "sound", "customer"]
    },  
        ...
        badges: ["food", "vegetable", "cooking", "fungus", "mushrooming"]
    },  
        ...
        badges: ["cancel", "close", "delete", "remove", "times", "clear", "no"]
    },  
        ...
        badges: ["shapes", "star", "password", "security"]
    },  
        ...
        badges: ["alert", "caution", "error", "search", "warning"]
    },  
        ...
        badges: ["coding", "programming", "development", "shape", "technology"]
    },  
        ...
        badges: ["app", "variation", "different", "variant", "alternative"]
    },  
        ...
        badges: ["electric", "electricity", "hybrid", "tesla", "station", "electronic", "point"]
    },  
        ...
        badges: ["parking", "parking-lot", "circle-parking", "vehicle-parking", "parking-zone", "parking-area", "parking-circle", "car-park", "round-parking", "circle-lot"]
    },  
        ...
        badges: ["shape", "tick", "accpet", "done", "yes"]
    },  
        ...
        badges: ["army", "badge", "military", "rank", "soldier", "war"]
    },  
        ...
        badges: ["keypad", "telephone", "phone", "call", "number"]
    },  
        {       key: 'IconFileXFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["food", "cooking", "restaurant", "bowl", "hot", "kitchen"]
    },  
        ...
        badges: ["safe", "security", "secure", "safety", "protect", "protection"]
    },  
        ...
        badges: ["subtract", "deduct", "reduce", "lessen", "remove", "six", "polygon", "shape", "cut", "decrease"]
    },  
        ...
        badges: ["video", "photography", "photo", "camera"]
    },  
        {       key: 'IconAssetFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["assembly", "engineering", "manufacturing", "production", "robotics"]
    },  
        ...
        badges: ["video", "film", "music", "player", "stop"]
    },  
        ...
        badges: ["prestige", "quality", "excellence", "dining", "gourmet", "restaurant", "top", "reputation", "award", "esteem"]
    },  
        ...
        badges: ["music", "forward", "play", "song", "playlist"]
    },  
        ...
        badges: ["shape", "circle", "down", "south"]
    },  
        ...
        badges: ["ipad", "mobile", "touchscreen", "portable"]
    },  
        ...
        badges: ["music", "instrument", "melody", "accesories"]
    },  
        ...
        badges: ["map", "location", "direction", "pin", "gps"]
    },  
        ...
        badges: ["fable", "cartoon", "mouse", "kids"]
    },  
        ...
        badges: ["inbox", "gmail", "email", "envelope", "message", "read"]
    },  
        ...
        badges: ["shape", "geometry", "round", "angle"]
    },  
        {       key: 'IconBladeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["browser", "page", "website", "web", "interface"]
    },  
        {       key: 'IconBadgeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["knight", "guard", "defence", "protect"]
    },  
        ...
        badges: ["support", "aid", "assist", "guide", "pyramid", "three", "angle", "corner", "pointed", "tip"]
    },  
        ...
        badges: ["comment", "chat", "reply", "communication", "conversation", "faq"]
    },  
        {       key: 'IconAwardFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["prize", "reward", "competition", "contest", "win"]
    },  
        ...
        badges: ["child", "infant", "cradle", "pram"]
    },  
        ...
        badges: ["good", "excited", "cheerful", "jolly", "delighted", "lucky"]
    },  
        ...
        badges: ["weight", "gym", "fitness", "powerlift"]
    },  
        ...
        badges: ["alarm", "bell", "notification", "sleep", "nap"]
    },  
        ...
        badges: ["rectangle", "side", "up", "north"]
    },  
        ...
        badges: ["text", "type", "line", "horizontal"]
    },  
        {       key: 'IconCoinFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["money", "earn", "salary", "change", "dollar"]
    },  
        ...
        badges: ["prohibit", "veto", "disallow", "prevent", "exclude", "bar", "inhibit", "restrain", "blacklist", "preclude"]
    },  
        ...
        badges: ["direction", "north", "up", "moving"]
    },  
        ...
        badges: ["css", "cascading", "style", "sheet", "background", "section", "website", "layer"]
    },  
        ...
        badges: ["news", "newspaper", "media", "blog"]
    },  
        {       key: 'IconTableFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["spreadsheet", "layout", "grid", "arrange", "row", "column"]
    },  
        ...
        badges: ["write", "school", "education", "stationery", "text"]
    },  
        ...
        badges: ["soup", "breakfast", "cereal", "cutlery", "utensils", "dine", "culinary", "cookware", "eat", "dish"]
    },  
        ...
        badges: ["direction", "south", "down", "moving"]
    },  
        ...
        badges: ["photo", "picture", "panoramic"]
    },  
        ...
        badges: ["favorite", "like", "mark", "grade", "bookmark", "space", "universe", "extraterrestrial", "galaxy"]
    },  
        ...
        badges: ["security", "secure", "locked", "password", "shape", "safe"]
    },  
        ...
        badges: ["mixer", "kitchen", "appliance", "blend", "food", "smoothie", "processing", "mixing", "grind", "blending"]
    },  
        ...
        badges: ["selected", "square", "magnifier", "enlargement"]
    },  
        ...
        badges: ["rectangle", "side", "down", "south"]
    },  
        ...
        badges: ["iphone", "phone", "smartphone", "cellphone"]
    },  
        ...
        badges: ["shape", "box", "figure", "geometry"]
    },  
        {       key: 'IconEggFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["vehicle", "charge", "motor", "current", "car", "electricity", "electric", "power"]
    },  
        ...
        badges: ["warning", "error", "shape", "caution", "alert"]
    },  
        ...
        badges: ["garbage", "delete", "remove", "bin", "ash-bin", "uninstall", "dustbin"]
    },  
        ...
        badges: ["order", "sequence", "increase", "arrange", "orderly", "progress", "upward", "hierarchy", "pattern", "system"]
    },  
        ...
        badges: ["mad", "feeling", "face", "nervous"]
    },  
        ...
        badges: ["statistics", "data", "value", "variable", "scale", "statistical"]
    },  
        ...
        badges: ["network", "connection", "collaboration", "people", "connect", "organization", "networking"]
    },  
        ...
        badges: ["low-vision", "blind", "disability", "handicapped"]
    },  
        ...
        badges: ["smoke", "smoking", "cannabis", "marijuana", "drugs"]
    },  
        ...
        badges: ["weather", "light", "mode", "brightness"]
    },  
        {       key: 'IconGaugeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["comment", "chat", "reply", "communication", "conversation"]
    },  
        ...
        badges: ["food", "cheese", "italy", "pepperoni", "margherita", "capricciosa", "rucole"]
    },  
        {       key: 'IconBoneFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["skeleton", "human", "dog", "body"]
    },  
        ...
        badges: ["warning", "danger", "caution", "risk"]
    },  
        ...
        badges: ["shape", "sign", "geometry", "geometric", "quadrilateral", "rhombus"]
    },  
        ...
        badges: ["photo", "photographer", "sharpen"]
    },  
        ...
        badges: ["shape", "card", "memory", "sim", "phone"]
    },  
        {       key: 'IconBugFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["germ", "insect", "error", "nature"]
    },  
        ...
        badges: ["position", "element", "design", "board", "processing", "task"]
    },  
        ...
        badges: ["magnifying", "glass", "magnifier", "earn", "pay", "sum", "total", "finance", "financial"]
    },  
        ...
        badges: ["picture", "photo", "camera", "polarization", "develop", "film", "lens"]
    },  
        ...
        badges: ["navigation", "safari", "travel", "direction", "discover"]
    },  
        ...
        badges: ["space", "comet", "astronomy", "galaxy", "cosmos"]
    },  
        ...
        badges: ["summer", "sun", "look", "shades", "eyewear"]
    },  
        ...
        badges: ["fly", "rocket", "transport", "space", "future"]
    },  
        {       key: 'IconWomanFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["medicine", "pharmaceutical", "pill", "treatment", "drug", "remedy", "softgel", "tablet", "horizontal", "health"]
    },  
        ...
        badges: ["money", "purchase", "payment", "cc"]
    },  
        ...
        badges: ["car", "vehicle", "torque", "transmission", "mechanics", "motor", "engine"]
    },  
        ...
        badges: ["jewellery", "crystal", "mineral", "jewelry", "ring"]
    },  
        ...
        badges: ["shape", "geometric", "math", "2d", "building", "government"]
    },  
        ...
        badges: ["call", "mobile", "conversation", "landline", "answer", "number"]
    },  
        ...
        badges: ["anatomy", "human", "medical", "respiratory", "breathe", "organ"]
    },  
        {       key: 'IconSaladFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["food", "vegetable", "vegan", "healthy"]
    },  
        ...
        badges: ["browser", "shape", "rectangle"]
    },  
        {       key: 'IconEyeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["dangerous", "precarious", "danger", "sign", "symbol", "warning", "caution", "chernobyl", "reactor", "atomic", "powerhouses", "generator"]
    },  
        ...
        badges: ["shape", "mic", "film", "netflix", "voice", "video"]
    },  
        ...
        badges: ["navigation", "map", "direction", "discover", "travel"]
    },  
        ...
        badges: ["plant", "garden", "rose", "lotus"]
    },  
        ...
        badges: ["music", "song", "playlist", "melody", "device", "voice", "recorder", "dictation", "machine"]
    },  
        ...
        badges: ["duplicate", "validate", "approve", "confirm", "replicate", "verification", "clone", "authorize", "endorse", "affirm"]
    },  
        ...
        badges: ["shape", "geometric", "math", "upright"]
    },  
        {       key: 'IconPillFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["drug", "medication", "illness", "sickness", "doctor", "prescription"]
    },  
        {       key: 'IconGiftFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["present", "birthday", "celebration", "wish", "bonus", "souvenire", "surprise"]
    },  
        ...
        badges: ["data", "model", "analysis", "multiple", "connection", "database", "link"]
    },  
        ...
        badges: ["face", "emoji", "emotion", "disgusted"]
    },  
        {       key: 'IconTagsFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["label", "price", "shopping", "promotion"]
    },  
        ...
        badges: ["portrait-crop", "aspect-ratio-portrait", "vertical-crop", "portrait-mode", "tall-crop", "portrait-format", "vertical-aspect", "vertical-frame", "portrait"]
    },  
        ...
        badges: ["fruit", "sweet", "summer", "refresh", "juicy", "round", "tropical", "cool", "refreshing", "tasty"]
    },  
        ...
        badges: ["pile", "elements", "layout", "wrap"]
    },  
        ...
        badges: ["navigation", "location", "travel", "pin", "position", "marker"]
    },  
        ...
        badges: ["funnel", "hopper", "filtration"]
    },  
        ...
        badges: ["shape", "marketing", "media", "promotion", "advertising", "advertisement"]
    },  
        ...
        badges: ["position", "element", "design", "grid", "footer"]
    },  
        ...
        badges: ["date", "day", "plan", "schedule", "agenda", "calender"]
    },  
        ...
        badges: ["airship", "transport", "ballon", "flying", "travel"]
    },  
        {       key: 'IconGlobeFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["world", "travel", "journey", "trip", "planet", "earth"]
    },  
        {       key: 'IconCrossFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["prayer", "church", "catholic", "jezus", "religion"]
    },  
        ...
        badges: ["details", "data", "fact", "three", "point", "warning", "alert", "caution", "notify", "symbol"]
    },  
        ...
        badges: ["shape", "agumented", "reality", "techonoly"]
    },  
        ...
        badges: ["identity", "person", "individual", "figure", "character", "personage", "being", "life", "human", "profile"]
    },  
        ...
        badges: ["face", "emoji", "emotion", "frown"]
    },  
        ...
        badges: ["alps", "camping", "mount", "everest", "trekking"]
    },  
        ...
        badges: ["graphics", "drawing", "design", "art", "canvas"]
    },  
        ...
        badges: ["universe", "extraterrestrial", "ufo", "space", "galaxy", "planet"]
    },  
        {       key: 'IconDiceFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["game", "boardgame", "roll", "throw", "cube", "numbers", "gambling"]
    },  
        ...
        badges: ["gambling", "game", "casino", "cards", "poker"]
    },  
        ...
        badges: ["asian", "meal", "noodles", "utensils", "dine", "cookware", "culinary", "dish", "eat", "serve"]
    },  
        ...
        badges: ["alarm", "bell", "notification", "add"]
    },  
        ...
        badges: ["party", "birthday", "decoration"]
    },  
        ...
        badges: ["change", "place", "position", "move", "exchange"]
    },  
        ...
        badges: ["crosshair", "shape", "geometry"]
    },  
        ...
        badges: ["shape", "geometry", "geometric", "graphic", "pyramid", "design"]
    },  
        ...
        badges: ["add", "augment", "increase", "enlarge", "expand", "six", "union", "build", "maximize", "extend"]
    },  
        {       key: 'IconBlobFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["shape", "form", "mass", "clump", "bulk", "group", "cluster", "lump", "patch", "chunk"]
    },  
        ...
        badges: ["equality", "good", "evil", "balance", "peace"]
    },  
        ...
        badges: ["delete", "remove", "eliminate"]
    },  
        ...
        badges: ["shop", "store", "buy", "purchase", "product", "bag", "trolley", "supermarket", "grocery"]
    },  
        {       key: 'IconCopyXFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["delete", "remove", "cancel", "erase", "discard", "nullify", "revoke", "void", "terminate", "clear"]
    },  
        ...
        badges: ["math", "count", "add", "subtract", "multiply", "divide", "amount"]
    },  
        {       key: 'IconAppleFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["fruit", "healthy", "diet", "fitness"]
    },  
        {       key: 'IconMouseFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["shape", "figure", "math", "graphic", "geometry", "form"]
    },  
        ...
        badges: ["fruit", "starfruit", "carambola", "tropical", "exotic", "five", "five-pointed", "star", "healthy", "vitamin", "nutrition", "diet"]
    },  
        ...
        badges: ["position", "element", "design", "arrangement"]
    },  
        ...
        badges: ["safety", "protect", "protection", "yes", "add"]
    },  
        ...
        badges: ["capture", "photo", "movement", "sound", "memory", "image", "camera"]
    },  
        {       key: 'IconGraphFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["analytics", "raport", "statistics", "chart"]
    },  
        ...
        badges: ["birds", "explorer", "field", "glasses", "magnifying", "eye", "glasses", "observe", "view", "watch"]
    },  
        {       key: 'IconCardsFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["game", "poker", "credit", "peyment", "casino"]
    },  
        ...
        badges: ["cancel", "no", "directory", "dir"]
    },  
        {       key: 'IconAlarmFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["coupon", "present", "voucher", "shopping", "birthday"]
    },  
        ...
        badges: ["finance", "discount", "interest", "rate", "calculation", "measurement", "ratio", "percent", "statistics", "math"]
    },  
        ...
        badges: ["money", "pay", "bank", "dollar", "pound", "yen", "business"]
    },  
        ...
        badges: ["assist", "support", "guide", "aid", "resolve", "explain", "instruct", "clarify"]
    },  
        {       key: 'IconPhotoFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["image", "picture", "landscape", "camera"]
    },  
        {       key: 'IconMoonFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["grid", "columns", "masonry", "collage"]
    },  
        ...
        badges: ["magnify", "enlarge", "analyze", "focus", "enhance", "view", "magnification", "zoom-in", "scan-zoom", "magnify-scan"]
    },  
        ...
        badges: ["soldier", "army", "private", "private", "second", "class", "private", "first", "class", "specialist", "corporal", "sergeant", "staff", "sergeant"]
    },  
        ...
        badges: ["fruit", "food", "sweet", "healthy"]
    },  
        {       key: 'IconHeartFilled',
                 svg: (width, height, color, strokeWidth) => (
        ...
        badges: ["love", "emotion", "like", "favorite", "relationship"]
    }
